package koerup.test.views.beautifulphotos;
...
@PageTitle("Beautiful photos")
@Route(value = "about", layout = MainLayout.class)
@Tag("beautifulphotos-view")
@JsModule("./views/beautifulphotos/beautifulphotos-view.ts")
public class BeautifulphotosView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public BeautifulphotosView() {
        addClassNames("beautifulphotos-view", "flex", "flex-col", "h-full");
